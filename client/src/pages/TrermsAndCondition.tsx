export default function TermsAndCondition() {
  return (
    <main className="w-full h-full bg-[#f7f7f7] flex justify-center items-center">
      <div className="w-full md:max-w-[60vw] bg-white px-9 pb-9 shadow-sm space-y-4">
        <p className="font-bold mt-8 uppercase">Terms And Condition</p>
        <p>
        ...
        <p className="font-medium">Collection of Your Information</p>
        <p>
